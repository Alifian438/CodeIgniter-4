...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <form action="/games/update/<?= $games2['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="sampulLama" value="<?= $games2['sampul']; ?>"> <!-- ini digunakan untuk menyimpan nama file lama kita -->
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <img src="/image/<?= $games2['sampul']; ?>" class="img-thumbnail img-preview"> <!-- ini digunakan untuk membuat gambar preview disamping inputan gambar dan source atau scr itu ada text phpp itu digunakan untuk mengambil gambar pada file tersebut -->
                    </div>
                    <div class="col-sm-8">
                        <div class="mb-3">
