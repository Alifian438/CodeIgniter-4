...
class Pages extends BaseController
{
    public function index()
    {
        $data = [                //variabel data untuk mendeklarasikan array, yang didalam array tersebut ada beberapa macam variabel 
            ...
            'about' => '',       //variabel about berisi string kosong karena saat index dijalankan saya tidak ingin teks about dan contact yang berada pada navbar kelihatan active maka dari itu saya memasukkan nilai string kosong pada variabel about.
            'contact' => '' //variabel about berisi string kosong karena saat index dijalankan saya tidak ingin teks about dan contact yang berada pada navbar kelihatan active maka dari itu saya memasukkan nilai string kosong pada variabel about.
        ];
    ...
    public function about()
    {
        $data = [ //variabel data untuk mendeklarasikan array, yang didalam array tersebut ada beberapa macam variabel
            ...
            'home' => '', //variabel home berisi string kosong karena saat about dijalankan saya tidak ingin teks home dan contact yang berada pada navbar kelihatan active maka dari itu saya memasukkan nilai string kosong pada variabel home.
            'contact' => '' //variabel home berisi string kosong karena saat about dijalankan saya tidak ingin teks home dan contact yang berada pada navbar kelihatan active maka dari itu saya memasukkan nilai string kosong pada variabel home.
        ];
        //echo view("pages/header", $data); //baris ini berfungsi untuk menjalankan header pada folder pages, dan saya menambahkan variabel data karena variabel data digunakan pada header.
    ...
    public function contact()
    {
        $data = [ //variabel data untuk mendeklarasikan array, yang didalam array tersebut ada beberapa macam variabel
            ...
            'about' => '', //variabel about berisi string kosong karena saat contact dijalankan saya tidak ingin teks home dan about yang berada pada navbar kelihatan active maka dari itu saya memasukkan nilai string kosong pada variabel about. 
            'home' => '', //variabel home berisi string kosong karena saat contact dijalankan saya tidak ingin teks home dam about yang berada pada navbar kelihatan active maka dari itu saya memasukkan nilai string kosong pada variabel home.
